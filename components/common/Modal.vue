...
.modal-container {
  ...
  .modal-card-container {
    ...
    .modal-card {
      @apply relative max-h-[600px] w-full max-w-[600px] transform overflow-hidden rounded-3xl rounded-[32px] bg-neutral-50 p-6 text-left text-black shadow-xl transition-all;
